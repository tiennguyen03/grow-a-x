...
| Epic 7: Complex Life — Sentience Progress & Civilization Tendencies | `docs/EPICS/Epic7.md` | Built (7B–7G: Sentience Progress + tendencies + Civ Identity + Tool Use milestone; playtest + Nova gate sign-off pending) |
